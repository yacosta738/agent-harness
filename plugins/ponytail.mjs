// ponytail — OpenCode plugin (vendored).
//
...
// License: MIT
//
// Loaded by OpenCode automatically from plugins/ponytail.mjs (per docs).
// Hooks + skills live in ../ponytail/ to keep the vendored unit portable.
...
const { getPonytailInstructions } = require('../ponytail/hooks/ponytail-instructions');
const { getDefaultMode, normalizePersistedMode } = require('../ponytail/hooks/ponytail-config');
