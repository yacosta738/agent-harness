...
**Purpose**: Functions are metered; static requests are free. `exclude` takes precedence. Max 100
rules, 100 char/rule.
...
**When to enable**: Global apps with D1/Durable Objects in specific regions, or apps with
