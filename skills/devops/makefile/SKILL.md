...
description: >
  ...
  Trigger: When creating, editing, or reviewing Makefiles (`Makefile`, `makefile`, `*.mk`, `GNUmakefile`),
  or when asked about GNU Make patterns, build automation, or makefile troubleshooting.
license: Apache-2.0
metadata:
  author: yacosta738
  version: "1.0"
