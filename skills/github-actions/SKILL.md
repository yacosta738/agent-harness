...
description: >
  ...
  Covers workflow structure, jobs, steps, secret management, caching, matrix strategies, testing, and deployment.
  Trigger: When creating, editing, or reviewing GitHub Actions workflows (`.github/workflows/*.yml`),
  or when asked about CI/CD pipelines, GitHub Actions best practices, or workflow optimization.
license: Apache-2.0
metadata:
  author: yacosta738
  version: "1.0"
