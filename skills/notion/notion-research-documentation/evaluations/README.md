...
5. Verify appropriate format is selected (Research Summary, Comprehensive Report, Quick Brief,
   Comparison)
...
1. **Test different research types** - Product research, competitive analysis, technical
...
- "Uses Research Summary format with sections: Executive Summary → Key Findings → Details →
